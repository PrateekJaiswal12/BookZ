        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="divide-y divide-gray-200">
            <form onSubmit={handleLogin} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              ...
              {error? <p className='text-red-600 text-base font-normal'>*Email or Password did not match</p> : ""}
              <div className="relative flex text-base font-normal items-center flex-col gap-2">
                  <p className=''>
                    Don't have an account ? <Link to="/sign-up" className='text-blue-500 hover:underline'>SignUp</Link>
                  </p>
                <button className="bg-blue-500 text-white w-1/2 rounded-md px-2 mt-4 py-2 hover:bg-blue-800 cursor-pointer">Log in</button>
              </div>
            </form>
          </div>
                  <hr/>
